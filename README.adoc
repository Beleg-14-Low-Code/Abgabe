...
.https://wiki.eclipse.org/images/8/8d/Using_MDD_Eclipse_Technology_to_implement_SOA.pdf
...
Die Entwicklung automatisierter Tests ist sehr zeitaufwändig. Statistisch gesehen nimmt die Entwicklung von automatisierten Tests zwischen 20 und 50 % der Entwicklungszeit in Anspruch [https://devm.io/testing/time-estimation-for-software-testing-128078].
